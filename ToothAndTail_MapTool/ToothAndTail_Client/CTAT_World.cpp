...
void CTAT_World::Render(void)
{
	...
	if (m_eGameResult == CTAT_World::RESULT_WIN) {
		CGraphicDevice::GetInstance()->RenderText(L"Victory!", D3DXVECTOR3(50.f , (WINCY >> 1) + 80.f, 0.f), 5.f, D3DCOLOR_ARGB(220, 0, 0, 200));
	}
	else if(m_eGameResult == CTAT_World::RESULT_LOSE) {
		CGraphicDevice::GetInstance()->RenderText(L"Defeat...", D3DXVECTOR3(50.f, (WINCY >> 1) + 80.f, 0.f), 5.f, D3DCOLOR_ARGB(220, 200, 0, 0));
	}
